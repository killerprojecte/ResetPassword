...
public final class FakeHusk extends FakeLiving {
    ...
    public EzClass create(String name, Location location) {
        return this.create(Ref.getNmsOrOld("world.entity.monster.EntityZombieHusk", "EntityZombieHusk"), "HUSK", "N", name, location);
    }
