...
public class SvgContent implements BodyContent {

    private final List<BodyContent> bodyContents = new ArrayList<>();
    private final Map<String,String> map = new HashMap<>();

    public SvgContent addSetting(String key, String value) {
        map.put(key, value);
        return this;
    }
    ...
    public SvgContent add(BodyContent bodyContent) {
    ...
    public String parseToString() {
        ...
        return "<svg " + out.substring(0, out.length()) + ">\n" + in + "</svg>";
    }
