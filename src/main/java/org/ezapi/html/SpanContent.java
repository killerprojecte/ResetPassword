...
public class SpanContent implements BodyContent {

    private final List<BodyContent> bodyContents = new ArrayList<>();
    private final Map<String,String> map = new HashMap<>();

    public SpanContent addSetting(String key, String value) {
        map.put(key, value);
        return this;
    }
    ...
    public SpanContent add(BodyContent bodyContent) {
    ...
    public String parseToString() {
        ...
        return "<span " + out.substring(0, out.length()) + ">\n" + in + "</span>";
    }
