...
public class FooterContent implements BodyContent {

    private final List<BodyContent> bodyContents = new ArrayList<>();
    private final Map<String,String> map = new HashMap<>();

    public FooterContent addSetting(String key, String value) {
        map.put(key, value);
        return this;
    }
    ...
    public FooterContent add(BodyContent bodyContent) {
    ...
    public String parseToString() {
        ...
        return "<footer " + out.substring(0, out.length()) + ">\n" + in + "</footer>";
    }
