...
public class ListContent implements BodyContent {

    private final List<BodyContent> bodyContents = new ArrayList<>();
    private final Map<String,String> map = new HashMap<>();

    public ListContent addSetting(String key, String value) {
        map.put(key, value);
        return this;
    }
    ...
    public ListContent add(BodyContent bodyContent) {
    ...
    public String parseToString() {
        ...
        return "<li " + out.substring(0, out.length()) + ">\n" + in + "</li>";
    }
