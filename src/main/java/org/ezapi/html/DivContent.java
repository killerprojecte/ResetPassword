...
public class DivContent implements BodyContent {

    private final List<BodyContent> bodyContents = new ArrayList<>();
    private final Map<String,String> map = new HashMap<>();

    public DivContent addSetting(String key, String value) {
        map.put(key, value);
        return this;
    }
    ...
    public DivContent add(BodyContent bodyContent) {
    ...
    public String parseToString() {
        ...
        return "<div " + out.substring(0, out.length()) + ">\n" + in + "</div>";
    }
